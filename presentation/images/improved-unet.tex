...
\node[rotate=45] at ($(cat4-north) + (-0.4,0,-4.5)$) {
	\textcolor{\ConcatColor}{\shortstack{Residual \\ Concatenation}}
};
...
\node[rotate=45] at ($(cat3-north) + (-0.6,0,-5.6)$) {
	\textcolor{\ConcatColor}{\shortstack{Residual \\ Concatenation}}
};
...
\node[rotate=45] at ($(cat2-north) + (-0.8,0,-6.2)$) {
	\textcolor{\ConcatColor}{\shortstack{Residual \\ Concatenation}}
};
...
\node[rotate=45] at ($(cat1-north) + (-1,0,-7.3)$) {
	\textcolor{\ConcatColor}{\shortstack{Residual \\ Concatenation}}
};
...
\node[rotate=45] at ($(ucr1-north) + (0,0,-6)$) {
	\shortstack{$7 \times 7$ conv \\ ReLU}
};
