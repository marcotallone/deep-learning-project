...
\node[rotate=45] at ($(cr1-north) + (0,0,-7)$) {$3 \times 3$ conv, ReLU};
...
\node[rotate=45] at ($(cr2-north) + (0,0,-6.2)$) {$3 \times 3$ conv, ReLU};
...
\node[rotate=45] at ($(cr3-north) + (0,0,-5.5)$) {$3 \times 3$ conv, ReLU};
...
\node[rotate=45] at ($(cr4-north) + (0,0,-4.5)$) {$3 \times 3$ conv, ReLU};
...
% \node[rotate=45] at ($(cr5-north) + (0,0,-3.8)$) {$3 \times 3$ conv, ReLU};
\node[rotate=45] at ($(cr5-north) + (0,0,-3)$) {\shortstack{$3 \times 3$ conv \\ ReLU}};
...
\path (cr5-east) -- (up4-south|-cr5-east) coordinate[pos=0.75] (crup4-mid);
...
\path (ucr4-east) -- (up3-south|-ucr4-east) coordinate[pos=0.65] (ucrup3-mid);
\draw[unpoolconnection,-Stealth] (ucr4-east) -- (ucrup3-mid) -- ($(ucrup3-mid) +
(0, 2.6)$);

% Unpooling connection 2
\path (ucr3-east) -- (up2-south|-ucr3-east) coordinate[pos=0.65] (ucrup2-mid);
\draw[unpoolconnection,-Stealth] (ucr3-east) -- (ucrup2-mid) -- ($(ucrup2-mid) +
(0, 3.5)$);

% Unpooling connection 1
\path (ucr2-east) -- (up1-south|-ucr2-east) coordinate[pos=0.65] (ucrup1-mid);
