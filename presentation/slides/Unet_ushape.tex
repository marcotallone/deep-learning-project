...
% Convolution 12 (alternative to draw them separately)
% \pic[shift={(0.5,0,0)}] at (cr11-east) {
% 	RightBandedBox={
% 		name=cr12,
% 		xlabel={{"32",""}},
% 		fill=\ConvColor,
...
% Unpooling 3
\pic[shift={(2,6.5,0)}] at (ucr4-east) {
	Box={
		name=up3,
		xlabel={{"128",""}},
		fill=\UnpoolColor,
...
% Unpooling 2
\pic[shift={(3,8.5,0)}] at (ucr3-east) {
	Box={
		name=up2,
		xlabel={{"64",""}},
		fill=\UnpoolColor,
...
% Unpooling 1
\pic[shift={(3.5,10,0)}] at (ucr2-east) {
	Box={
		name=up1,
		xlabel={{"32",""}},
		fill=\UnpoolColor,
