...
\begin{frame}
    ...
    \begin{center}
        % \hspace*{-0.7cm}
        \includegraphics[width=\textwidth]{vgg_arc.png}
    \end{center}
    ...
    \begin{cbox}
        \begin{itemize}
            \item All the other hyperparameters and settings are the same for
							all models \gray{\itt{(batch size, optimizer, epochs, etc\dots)}}
            \item Note that the \green{\textbf{CustomCNN} is the one with less
							parameters ($3,001,156$)} while \red{\textbf{VGG16} is the one
							with more parameters($65,070,916$)}
            \item \textbf{VGG16} also has the \mbox{\red{highest dropout rate ($0.5$)}}
        \end{itemize}
    \end{cbox}
...
\begin{frame}
    ...
    \begin{center}
        \includegraphics[width=0.9\textwidth]{ale_conf.png}
    \end{center}
...
\begin{frame}
    ...
    \begin{center}
        \includegraphics[width=0.9\textwidth]{conf_vgg.png}
    \end{center}
...
\begin{frame}
    ...
    \begin{warning}
			Note that these are the values reached during the \byellow{last epoch}.
    \end{warning}
...
\begin{frame}
    ...
    \begin{center}
        \includegraphics[width=\textwidth]{accuracy_compared.png}
    \end{center}
\end{frame}
...
\begin{frame}
    ...
    % \end{tabular}\\
		...
		\begin{warning}
			Note that these are the values reached after the \byellow{last epoch}.
		\end{warning}
