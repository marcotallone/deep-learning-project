# CNN models training script for segmentation task on the BraTS2020 dataset
...
from utils.train import get_device, train_multiclass
...
# ⚠ WARNING: These loads the dataset with data augmentation and hyperparameters
# used only for the training of our CustomCNN model. Original AlexNet and VGG16
# metrics have been obtained following their respective training procedures
# stated in the papers and thus ocassionally commenting out relevant lines in
# the called function modules
...
for images, labels in train_dataloader:
    print(
        "Training batch   - Images shape:", images.shape, "Labels shape:", labels.shape
    )
    break
for images, labels in valid_dataloader:
    print(
        "Validation batch - Images shape:", images.shape, "Labels shape:", labels.shape
    )
    break
